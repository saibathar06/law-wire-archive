...
const CompactHeader = ({ onContactClick }: CompactHeaderProps) => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex justify-center">
            <Link 
              to="/" 
              className="text-2xl md:text-3xl font-bold text-legal-navy tracking-wider hover:text-legal-gold transition-colors"
            >
              FAIRLAW
            </Link>
          </div>
        ...
        <nav className="hidden md:flex items-center justify-center space-x-8 py-3 text-sm border-t border-border">
          <Link 
            to="/" 
          ...
          {categories.map((category) => (
            <div key={category.slug} className="relative group">
              {category.subcategories ? (
                <>
                  <button className="text-foreground font-medium hover:text-primary tracking-wider flex items-center transition-colors">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-background absolute w-full left-0 shadow-lg border-t border-border">
            <Link 
              to="/"
