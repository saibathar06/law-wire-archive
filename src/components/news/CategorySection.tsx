              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {breakingNews && (
                  <Link to={`/article/${breakingNews.id}`}>
                    <Card className="group hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden md:col-span-2 lg:col-span-3 mb-8 border-2 border-destructive/40 bg-gradient-to-r from-destructive/5 to-transparent">
